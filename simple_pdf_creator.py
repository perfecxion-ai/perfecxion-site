...
def create_simple_pdf_with_logo(title, content, output_path, logo_path):
    """Create a simple PDF with logo and clean content"""
    ...
    # Read the generated PDF and add logo
...
def create_clean_pdfs():
    """Create clean PDFs with correct logo"""
