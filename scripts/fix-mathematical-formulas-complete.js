...
// Function to fix ALL remaining mathematical formula issues
function fixMathematicalFormulasComplete(content) {
  // Fix remaining broken Dₜ₊₁ notation
...
function processAllFiles() {
    ...
    for (const item of items) {
      ...
      if (stat.isDirectory()) {
        ...
        try {
          ...
          content = fixMathematicalFormulasComplete(content);
  ...
  console.log('\n🎉 Complete mathematical formula fixing complete!');
}
...
module.exports = { fixMathematicalFormulasComplete };
