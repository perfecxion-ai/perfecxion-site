...
function fixMathematicalFormulasFinal(content) {
...
function processAllFiles() {
    ...
    for (const item of items) {
      ...
      if (stat.isDirectory()) {
        ...
        try {
          ...
          content = fixMathematicalFormulasFinal(content);
  ...
  console.log('\n🎉 Final mathematical formula fixing complete!');
}
...
module.exports = { fixMathematicalFormulasFinal };
