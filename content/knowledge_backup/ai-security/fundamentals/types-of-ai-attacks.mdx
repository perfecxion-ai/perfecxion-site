...
### Malicious Example: Adversarial Example Generation

Below is a concise PyTorch example showing how to generate adversarial examples using the Fast Gradient Sign Method (FGSM). This demonstrates a real-world attack technique against deployed models.
...
# Example usage (mocked model/data)
class DummyModel:
  def __call__(self, x):
...
**Context:**
This code demonstrates how adversarial examples can be generated to fool AI models. Defenders should use adversarial training and input validation to reduce vulnerability to these attacks.
