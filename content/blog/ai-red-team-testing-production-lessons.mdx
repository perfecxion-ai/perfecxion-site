...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
  <div className="border border-gray-300 dark:border-gray-700 rounded-lg p-6">
    <div className="flex items-center gap-3 mb-4">
      ...
      <h3 className="text-lg font-bold">Information Leakage Patterns</h3>
    </div>
  ...
  <div className="border border-gray-300 dark:border-gray-700 rounded-lg p-6">
    <div className="flex items-center gap-3 mb-4">
      ...
      <h3 className="text-lg font-bold">Multi-Model Orchestration Risks</h3>
    </div>
    <div className="text-gray-600 dark:text-gray-400">
...
<div className="bg-red-200 dark:bg-red-900/20 border-l-4 border-red-600 p-6 mb-8 shadow-sm">
  <div className="flex items-start gap-3">
    ...
    <div>
      <h3 className="font-bold text-red-900 dark:text-red-200 mb-2">Critical Gap in Security Visibility</h3>
...
<div className="bg-green-200 dark:bg-green-900/20 border-l-4 border-green-600 p-6 mb-8 shadow-sm">
  <div className="flex items-start gap-3">
    ...
    <div>
      <h3 className="font-bold text-green-900 dark:text-green-200 mb-2">Proven Success Pattern</h3>
...
<div className="bg-gradient-to-r from-primary-500 to-primary-700 rounded-lg p-8 text-white mb-8">
  <h3 className="text-2xl font-bold mb-4">Key Takeaways from Extensive Testing</h3>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="bg-white/10 rounded-lg p-4">
      ...
      <div className="text-sm text-primary-100">Security testing must be ongoing, not periodic</div>
    </div>
    <div className="bg-white/10 rounded-lg p-4">
      <h4 className="font-semibold mb-2">🔍 Specialized Monitoring</h4>
      <div className="text-sm text-primary-100">AI-aware tools are essential for threat detection</div>
    </div>
    <div className="bg-white/10 rounded-lg p-4">
      <h4 className="font-semibold mb-2">🏗️ Security Architecture</h4>
      <div className="text-sm text-primary-100">Build security into AI systems from inception</div>
    </div>
  </div>
</div>

<div className="bg-gray-100 dark:bg-gray-900 rounded-lg p-6 text-center">
  <h3 className="text-xl font-bold mb-4">Secure Your Production AI Systems</h3>
