...
<h5 class="font-semibold text-yellow-900 dark:text-yellow-200 mb-2"> The Detection Challenge</h5>
...
<h4 class="font-bold mb-3 text-xl"> Continuous Validation</h4>
...
<div class="bg-white/20 backdrop-blur rounded-lg p-6">
<h4 class="font-bold mb-3 text-xl"> Security Architecture</h4>
