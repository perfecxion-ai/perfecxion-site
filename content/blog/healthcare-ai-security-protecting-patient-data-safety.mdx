...
<div className="bg-gradient-to-r from-red-600 via-blue-600 to-green-600 text-white p-8 rounded-lg mb-8">
...
<div>
<h2 className="text-3xl font-bold mb-2 text-white">Healthcare AI Security</h2>

<div className="text-white/90">Protecting lives and data in the most critical AI deployments</div>
</div>
...
<span className="font-semibold text-white">500M+ Systems</span>
</div>

<div className="text-sm text-white/90">AI systems in healthcare globally</div>
</div>
...
<span className="font-semibold text-white">3.2B Records</span>
</div>

<div className="text-sm text-white/90">Patient records protected</div>
</div>
...
<span className="font-semibold text-white">$10.9M</span>
</div>

<div className="text-sm text-white/90">Average breach cost</div>
</div>
...
<div>
<h3 className="text-lg font-bold text-yellow-900 dark:text-yellow-200 mb-3">Life-Critical Systems Alert</h3>
...
<div className="bg-gradient-to-br from-blue-50 to-green-50 dark:from-blue-950/30 dark:to-green-950/30 border border-blue-200 dark:border-blue-800 rounded-xl p-6 my-8">
<h3 className="text-lg font-semibold mb-4 text-blue-800 dark:text-blue-200">Healthcare AI Security Framework</h3>
...
<div>
<h3 className="text-lg font-bold text-blue-900 dark:text-blue-200 mb-3">The Human Factor</h3>
...
<h4 className="text-md font-semibold mb-3 text-green-800 dark:text-green-200">HIPAA AI Compliance Checklist</h4>
...
<h4 className="text-md font-semibold mb-3 text-red-800 dark:text-red-200">Patient Safety Risk Matrix</h4>
...
<div>
<h3 className="text-lg font-bold text-green-900 dark:text-green-200 mb-3">Regulatory Success Story</h3>
...
<h4 className="text-md font-semibold mb-3 text-purple-800 dark:text-purple-200">Privacy-Preserving Healthcare AI</h4>
...
<h4 className="text-md font-semibold mb-3 text-orange-800 dark:text-orange-200">Healthcare AI Incident Classification</h4>
...
<div>
<h3 className="text-lg font-bold text-blue-900 dark:text-blue-200 mb-3">Scale and Security</h3>
<p className="text-blue-800 dark:text-blue-300 leading-relaxed">
...
<div className="bg-gradient-to-br from-blue-50 to-green-50 dark:from-blue-950/30 dark:to-green-950/30 border border-blue-200 dark:border-blue-800 rounded-xl p-6 my-8">
<h4 className="text-md font-semibold mb-3 text-blue-800 dark:text-blue-200">Healthcare AI Security Maturity Model</h4>
...
<div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-950/30 dark:to-blue-950/30 border border-green-200 dark:border-green-800 rounded-xl p-6 my-8">
<h3 className="text-lg font-semibold mb-4 text-green-800 dark:text-green-200">Ready to Secure Your Healthcare AI Systems?</h3>
...
<Link href="/docs" className="inline-flex items-center px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors font-medium">
