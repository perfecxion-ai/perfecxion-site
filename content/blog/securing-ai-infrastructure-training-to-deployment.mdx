...
<div className="space-y-3 text-yellow-800 dark:text-yellow-300">
  <li><strong>Supply Chain Attacks:</strong> Malicious dependencies in training frameworks</li>
  <li>><strong>Resource Hijacking:</strong> Cryptomining on GPU clusters</li>
  <li><strong>Model Poisoning:</strong> Backdoors inserted during training</li>
  <li><strong>Hyperparameter Tampering:</strong> Subtle changes that degrade performance</li>
  <li><strong>Checkpoint Manipulation:</strong> Corrupting saved training states</li>
</div>
