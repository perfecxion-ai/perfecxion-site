...
<StatsBox stats={[
  { label: "CISOs concerned about AI threats", value: "78%", icon: <Shield className="h-8 w-8 text-red-600" /> },
  { label: "Incidents involving GenAI", value: "70%", icon: <AlertTriangle className="h-8 w-8 text-orange-600" /> },
  { label: "Organizations lacking expertise", value: "58%", icon: <Users className="h-8 w-8 text-yellow-600" /> },
  { label: "Detection recall rate", value: "0.16", icon: <Eye className="h-8 w-8 text-blue-600" /> }
]} />
...
<StatsBox stats={[
  { label: "False Positive Reduction", value: "93%", icon: <CheckCircle className="h-8 w-8 text-green-600" /> },
  { label: "Detection Latency", value: "<300ms", icon: <Zap className="h-8 w-8 text-yellow-600" /> },
  { label: "SOC 2 Compliance", value: "Type 2", icon: <Shield className="h-8 w-8 text-blue-600" /> },
  { label: "Model Coverage", value: "100%", icon: <Eye className="h-8 w-8 text-purple-600" /> }
]} />
