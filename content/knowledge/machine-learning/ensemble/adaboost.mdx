...
t+1 , are updated to give more importance to the samples that were misclassified by hₜ. The update rule is:
...
**t Dₜ(i) · e** 
**-yᵢαₜhₜ(xᵢ)** where Z 
t is a normalization factor that ensures the new weights sum to 1 (Z 
**t = Σᵢ₌₁ᴺ Dₜ(i) · e** 
**-yᵢαₜhₜ(xᵢ)**
