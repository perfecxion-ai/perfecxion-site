...
- [Part I: Foundational Principles](#part-i-foundational-principles-of-centroid-based-clustering)
  - [1. Core Algorithm](#1-the-core-iterative-algorithm-expectation-maximization-in-practice)
  - [2. Algorithm Steps](#2-algorithm-steps)
  - [3. Initialization Methods](#3-initialization-methods)
...
### 1. The Core Iterative Algorithm: Expectation-Maximization in Practice
...
This example demonstrates the K-means algorithm step-by-step, showing how centroids move and clusters form through iterative refinement.
...
μ 
i
(t+1) , is calculated as the arithmetic mean of all data points that were assigned to that cluster in the previous step.
...
i
(t) ∑ x 
j Step 4: Iteration and Convergence
