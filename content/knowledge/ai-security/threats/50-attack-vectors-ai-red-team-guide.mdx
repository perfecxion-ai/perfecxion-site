...
Below is a concise Python example showing how a red team might simulate a prompt injection attack against an LLM-based system.

```python
def simulate_prompt_injection(system_prompt, user_input):
    # Simulate LLM processing by combining system and user input
...
**Context:**
This code simulates a prompt injection attack, demonstrating how user input can override system instructions. Red teams use such tests to validate model resilience and identify weaknesses.
