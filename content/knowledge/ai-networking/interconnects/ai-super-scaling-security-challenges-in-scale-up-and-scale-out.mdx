...
description: >-
  Security implications of scaling AI infrastructure both vertically and
  horizontally
...
---
### Practical Example: Estimating NVLink Domain Power and Cooling Requirements

```python
# Estimate power and cooling requirements for an NVL72 rack-scale system
# Useful for facility planning and TCO modeling
nvl72_tdp_kw = 132  # Thermal Design Power in kW (max)
pue = 1.5           # Power Usage Effectiveness (facility overhead)

cooling_required_kw = nvl72_tdp_kw * (pue - 1)
total_facility_power_kw = nvl72_tdp_kw * pue

print(f"NVL72 Rack Power: {nvl72_tdp_kw} kW")
print(f"Cooling Required: {cooling_required_kw} kW")
print(f"Total Facility Power: {total_facility_power_kw} kW")
```

*This code helps data center architects estimate the real-world power and cooling impact of deploying NVL72 rack-scale systems. Use it to validate facility readiness and plan infrastructure upgrades for AI supercomputing.*
